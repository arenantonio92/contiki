...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <commands EXPORT="discard">make udp-server.z1 TARGET=z1 WITH_COMPOWER=1</commands>
    ...
    <motetype>
      ...
      <commands EXPORT="discard">make udp-client.z1 TARGET=z1 WITH_COMPOWER=1</commands>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>62.9710040960604</x>
        <y>32.548163394370675</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>31.46759526330257</x>
        <y>31.52098263209352</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>30.849853666719685</x>
        <y>61.57128198427654</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>63.36954844927903</x>
        <y>60.88452858659513</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.220282518200247 0.0 0.0 2.220282518200247 159.017526009163 10.713084944259057</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
